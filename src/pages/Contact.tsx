        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              {/* Text Content */}
              <div>
                <h1 className="text-5xl lg:text-6xl font-montserrat font-bold text-white mb-6 leading-tight">
                  Contact Us
                  <span className="block text-secondary text-3xl lg:text-4xl mt-3">
                    Let's Start the Conversation
                  </span>
                </h1>
                <p className="text-xl lg:text-xl font-lato text-white/95 mb-8 leading-relaxed">
                ...
                <div className="flex flex-wrap gap-3 mb-8">
                  <span className="bg-white/20 backdrop-blur-md rounded-full px-4 py-2 text-sm font-montserrat font-semibold text-white">
                    Free Consultation
                  </span>
                  <span className="bg-white/20 backdrop-blur-md rounded-full px-4 py-2 text-sm font-montserrat font-semibold text-white">
                    Expert Guidance
              ...
              <div className="relative">
                <div className="grid grid-cols-2 gap-6">
                  ...
                  <div className="bg-white/15 backdrop-blur-md rounded-2xl p-6 border border-secondary/20 hover:bg-white/20 transition-all duration-300">
                    ...
                    <h3 className="font-montserrat font-bold text-white mb-2">Call Us</h3>
                    <p className="text-sm text-white/90">Direct line to our experts</p>
                  </div>
                  
                  <div className="bg-white/15 backdrop-blur-md rounded-2xl p-6 border border-secondary/20 hover:bg-white/20 transition-all duration-300">
                    <Mail className="w-12 h-12 text-secondary mb-4" />
                    <h3 className="font-montserrat font-bold text-white mb-2">Email Us</h3>
                    <p className="text-sm text-white/90">Professional correspondence</p>
                  </div>
                  
                  <div className="bg-white/15 backdrop-blur-md rounded-2xl p-6 border border-secondary/20 hover:bg-white/20 transition-all duration-300">
                    <MapPin className="w-12 h-12 text-secondary mb-4" />
                    <h3 className="font-montserrat font-bold text-white mb-2">Visit Us</h3>
                    <p className="text-sm text-white/90">Biratnagar office location</p>
                  </div>
                  
                  <div className="bg-white/15 backdrop-blur-md rounded-2xl p-6 border border-secondary/20 hover:bg-white/20 transition-all duration-300">
                    <Calendar className="w-12 h-12 text-secondary mb-4" />
                    <h3 className="font-montserrat font-bold text-white mb-2">Schedule</h3>
                    <p className="text-sm text-white/90">Book consultation meeting</p>
                  </div>
                </div>
